    ...
    <div className="min-h-[95vh] bg-gradient-to-br from-zinc-50 via-white to-blue-50 dark:from-zinc-900 dark:via-zinc-950 dark:to-blue-950 py-10 px-2 md:px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-10 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-2 text-primary">Your Health Progress</h1>
          <p className="text-lg text-zinc-500 max-w-2xl mx-auto">Track your journey, celebrate your wins, and stay motivated every day!</p>
        </div>
        {/* Stat Cards & Badges */}
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
          {demoStats.map((stat, i) => (
            <div key={i} className="bg-white dark:bg-zinc-900 rounded-xl shadow border border-zinc-200 dark:border-zinc-800 flex flex-col items-center py-5 px-2">
              <div>{stat.icon}</div>
              <div className="text-2xl font-bold mt-2">{stat.value}<span className="text-base font-normal ml-1">{stat.unit}</span></div>
        ...
        <div className="flex flex-wrap gap-3 mb-10 justify-center">
          {demoBadges.map((badge, i) => (
            <div key={i} className="flex items-center gap-2 bg-gradient-to-r from-yellow-100 via-green-100 to-cyan-100 dark:from-yellow-900 dark:via-green-900 dark:to-cyan-900 rounded-full px-4 py-2 shadow text-sm font-semibold">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-lg border border-zinc-200 dark:border-zinc-800 p-8 mb-12">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
            <h2 className="text-2xl font-bold text-primary">Progress Over Time</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-lg border border-zinc-200 dark:border-zinc-800 p-6 flex flex-col gap-6">
            <h3 className="text-xl font-bold text-primary mb-2">Today's Progress</h3>
            <div>
              <div className="flex justify-between mb-1 text-sm"><span>Water</span><span>2.3L / 3L</span></div>
              <div className="w-full h-3 bg-zinc-200 dark:bg-zinc-800 rounded-full overflow-hidden mb-3"><div className="h-full bg-cyan-400" style={{ width: "77%" }} /></div>
              <div className="flex justify-between mb-1 text-sm"><span>Steps</span><span>8200 / 10000</span></div>
              <div className="w-full h-3 bg-zinc-200 dark:bg-zinc-800 rounded-full overflow-hidden mb-3"><div className="h-full bg-blue-400" style={{ width: "82%" }} /></div>
              <div className="flex justify-between mb-1 text-sm"><span>Calories</span><span>1850 / 2000</span></div>
              <div className="w-full h-3 bg-zinc-200 dark:bg-zinc-800 rounded-full overflow-hidden"><div className="h-full bg-red-400" style={{ width: "92%" }} /></div>
            </div>
            <button className="mt-4 w-full flex items-center justify-center gap-2 py-2 rounded-lg bg-primary text-white font-semibold shadow hover:bg-primary/90 transition"><FileText className="w-5 h-5" /> Log Today</button>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-100 via-green-50 to-cyan-100 dark:from-blue-900 dark:via-green-950 dark:to-cyan-950 rounded-2xl shadow-lg border border-zinc-200 dark:border-zinc-800 p-6 flex flex-col items-center justify-center gap-6">
            ...
            <div className="flex items-center gap-2 text-primary font-bold text-xl"><Trophy className="w-6 h-6" /> {streak} day streak!</div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-lg border border-zinc-200 dark:border-zinc-800 p-6">
            <h3 className="text-xl font-bold text-primary mb-4 flex items-center gap-2"><Camera className="w-5 h-5" /> Progress Photos</h3>
            <div className="flex gap-4">
              {gallery.map((src, i) => (
                <img key={i} src={src} alt="Progress" className="w-24 h-24 object-cover rounded-xl border border-zinc-200 dark:border-zinc-800 shadow" />
              ))}
            </div>
            <button className="mt-4 w-full flex items-center justify-center gap-2 py-2 rounded-lg bg-primary text-white font-semibold shadow hover:bg-primary/90 transition"><Camera className="w-5 h-5" /> Upload Photo</button>
          </div>
          {/* Notes/Journal */}
          <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-lg border border-zinc-200 dark:border-zinc-800 p-6 flex flex-col h-full">
            <h3 className="text-xl font-bold text-primary mb-4 flex items-center gap-2"><FileText className="w-5 h-5" /> Notes & Journal</h3>
            <textarea
        ...
        <div className="flex justify-center mb-8">
          <button className="flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-primary to-blue-400 text-white font-bold shadow-lg hover:from-primary/90 hover:to-blue-500 transition text-lg"><Download className="w-6 h-6" /> Export Data</button>
        </div>
      </div>
    </div>
  );
