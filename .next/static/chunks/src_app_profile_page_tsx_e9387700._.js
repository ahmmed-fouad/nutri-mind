...
function ProfilePage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProfilePage.useEffect": ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getUser().then({
                "ProfilePage.useEffect": ({ data })=>setUser(data.user)
            }["ProfilePage.useEffect"]);
        }
    }["ProfilePage.useEffect"], []);
    ...
    const userForm = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"])({
        "ProfilePage.useSelector[userForm]": (state)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$userFormApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["selectUserForm"])(state.userForm, userId)
    }["ProfilePage.useSelector[userForm]"]);
        ...
        "ProfilePage.useEffect": ()=>{
            if (user?.user_metadata?.avatar_url) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from("avatars").download(`${user.id}/avatar.jpg`).then({
                    "ProfilePage.useEffect": ({ data, error })=>{
                        if (!error && data) {
    ...
    const handlePhotoUpload = async (e)=>{
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from("avatars").upload(filePath, file, {
            upsert: true
        });
        if (!error) {
            const { data } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from("avatars").getPublicUrl(filePath);
    ...
    const handleSubmit = async (e)=>{
        ...
        if (form.name && form.name !== user?.user_metadata?.name) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.updateUser({
                data: {
                    name: form.name
                }
            });
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        className: "flex flex-col items-center justify-center min-h-[60vh] bg-zinc-50 dark:bg-zinc-900/60",
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: "Click photo to change"
                        }, void 0, false, {
                            fileName: "[project]/src/app/profile/page.tsx",
                            lineNumber: 140,
                            columnNumber: 11
...
_s(ProfilePage, "xOvid0rW+U6KAzYPUcIvUzXK+sc=", false, function() {
    return [
