...
(()=>{
    const e = new Error("Cannot find module '../../stores/services/streamApi'");
...
const ChatBot = ()=>{
    ...
    const handleSend = async ()=>{
        ...
        setIsFetching(true);
        try {
            await streamChat(input, async (chunk)=>{
                await delay(800);
...
//# sourceMappingURL=src_components_chatbot_index_tsx_c3dd2da9._.js.map