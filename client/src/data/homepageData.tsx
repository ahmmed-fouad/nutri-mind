...
import { Flame,User,Droplet,Footprints, CheckCircle, TrendingUp, ListTodo, ShoppingBasket, BookOpen, FileText, LifeBuoy, Bot } from "lucide-react";
...
export const macroColors = ["#34d399", "#60a5fa", "#fbbf24"];
export const calorieBarColor = "#4f46e5";
export const dietaryPrefs = [
  "None",
  "Vegan",
  "Vegetarian",
  "Keto",
