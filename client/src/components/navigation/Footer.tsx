...
export default function Footer() {
  return (
    <footer className="w-full bg-background border-t border-border px-15 p-5 flex flex-col gap-8 items-center glassmorphism-footer">
      {/* Footer search input */}
      ...
      <div className="w-full max-w-7xl flex gap-4 items-start ">
        ...
        <div className="flex flex-col flex-1 gap-2 items-center">
          ...
          <div className="grid grid-cols-3 md:grid-cols-4 gap-x-8 gap-y-2">
