        ...
        <div className="flex flex-col md:flex-row gap-6 items-center justify-center">
          <div className="flex flex-col gap-3 w-full md:w-1/2">
            ...
            <input
              ...
              className="input glassmorphism text-gray-800"
            />
            {image && (
              <img
                src={image}
          ...
          <div className="flex flex-col gap-3 w-full md:w-1/2">
            ...
            <form onSubmit={handleBarcodeSubmit} className="flex gap-2">
              <input
                ...
                className="input glassmorphism flex-1 text-gray-800"
          ...
          <div className="glassmorphism p-6 rounded-2xl shadow-xl flex flex-col gap-6">
            ...
            <ul className="flex flex-wrap gap-2">
              {food.ingredients.map((ing: string, i: number) => (
                <li
                  key={i}
                  className="px-3 py-1 rounded-full bg-gradient-to-r from-green-100 via-blue-100 to-yellow-100 text-sm font-semibold shadow"
                >
                  {ing}
                </li>
              ))}
