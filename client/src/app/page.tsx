        ...
        <div className="flex flex-col md:flex-row items-center gap-10 mb-16">
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start mb-6">
              <Link href="/chatbot" className="px-6 py-3 rounded-xl bg-primary text-white font-bold shadow-lg hover:bg-primary/90 transition text-lg flex items-center gap-2"><Bot className="w-6 h-6" /> Start Chatting</Link>
              <Link href="/form" className="px-6 py-3 rounded-xl bg-zinc-100 dark:bg-zinc-800 text-primary font-bold shadow hover:bg-primary/10 transition text-lg flex items-center gap-2"><Flame className="w-6 h-6" /> Plan My Meals</Link>
            </div>
          </div>
          {/* Animated Chatbot UI */}
